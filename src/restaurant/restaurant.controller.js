...
var RestaurantController = function () {
    ...
    var RestaurantController = _classThis = /** @class */ (function () {
        ...
        RestaurantController_1.prototype.create = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.restaurantService.create(body)];
                        case 1:
                            _a.sent();
        ...
        RestaurantController_1.prototype.update = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.restaurantService.update(body)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, true];
                    }
        ...
        RestaurantController_1.prototype.getAll = function () {
            return "hello";
        };
    ...
    (function () {
        ...
        _update_decorators = [(0, common_1.Put)('/update')];
