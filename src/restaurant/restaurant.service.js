...
var RestaurantService = function () {
    ...
    var RestaurantService = _classThis = /** @class */ (function () {
        function RestaurantService_1(restaurants) {
            this.restaurants = restaurants;
        }
        RestaurantService_1.prototype.getAll = function () {
            return this.restaurants.find();
        };
        RestaurantService_1.prototype.create = function (body) {
            var newRestaurant = this.restaurants.create(body);
            return this.restaurants.save(newRestaurant);
        };
        RestaurantService_1.prototype.update = function (body) {
